...
<head>
    ...
    <title>Manage Professionals | MindCare Admin</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Professional Applications</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($professionals as $professional)
                                        <tr>
                                            ...
                                            <td>{{ $professional->created_at->format('M d, Y') }}</td>
                                            <td>
                                                ...
                                                @if($professional->status == 'pending')
                                                    <form action="{{ route('admin.professionals.approve', $professional) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('Are you sure you want to approve this professional?')">
                                                            <i class="fas fa-check"></i> Approve
                                                        </button>
                                                    </form>
                                                    <form action="{{ route('admin.professionals.reject', $professional) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to reject this professional?')">
